...
export default function MenuCartPage() {
  ...
  return (
    <div
      className={`fixed h-screen z-40 flex flex-col duration-500 bg-white ${cartModalOpened ? "inset-y-0 inset-x-0 opacity-100 visible" : "-inset-y-7 inset-x-0 opacity-0 invisible"}`}
    >
